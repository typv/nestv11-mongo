...
import { BodyContentType } from 'src/common/enums';
import { HttpErrorResponseDto, PaginationResponseDto } from 'src/common/dto';
...
function addApiResponse(option: ApiResponseOptions, decorators: (MethodDecorator | ClassDecorator)[]) {
