...
import { PractitionerCancelAppointmentPractitionerEmailProps } from '../types'
import { extractDate } from '../utils'

export const PractitionerCancelAppointmentPractitionerEmail = ({
...
export default PractitionerCancelAppointmentPractitionerEmail
