...
import { CreateAppointmentClinicEmailProps } from '../types'
import { extractDate } from '../utils'

export const CreateAppointmentClinicEmail = ({
	...
	patientType = 'New',
	bookedBy = 'Patient',
}: CreateAppointmentClinicEmailProps) => (
	<EmailLayout>
		<Preview>
...
export default CreateAppointmentClinicEmail
