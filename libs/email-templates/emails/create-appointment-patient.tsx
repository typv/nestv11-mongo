...
import { CreateAppointmentPatientEmailProps } from '../types'
import { extractDate } from '../utils'

export const CreateAppointmentPatientEmail = ({
	...
	feeSuffix = '$',
}: CreateAppointmentPatientEmailProps) => (
	<EmailLayout>
		<Preview>
			Appointment Confirmed with {practitionerName} on{' '}
		...
		<div className="bg-white m-0 mb-8 text-trueGray">
			<div>
				...
				<Text className="text-base leading-6 mb-6 mt-0">
					If you need to make any changes to your appointment, please log into
					your account or contact us at{' '}
...
export default CreateAppointmentPatientEmail
