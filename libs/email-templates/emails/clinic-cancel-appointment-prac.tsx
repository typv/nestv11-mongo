...
import { ClinicCancelAppointmentPractitionerEmailProps } from '../types'
import { extractDate } from '../utils'

export const ClinicCancelAppointmentPractitionerEmail = ({
...
}: ClinicCancelAppointmentPractitionerEmailProps) => (
	<EmailLayout>
		<Preview>
		...
		<div className="bg-white m-0 mb-8 text-trueGray">
			<div>
				...
				<Text className="text-base leading-6 mb-6 mt-0">
					You has canceled an upcoming appointment with a patient. Details are
					below:
				</Text>
				...
				<Text className="text-base leading-6 mb-6 mt-0">
					Please ensure the patient has been notified and assist with
...
export default ClinicCancelAppointmentPractitionerEmail
