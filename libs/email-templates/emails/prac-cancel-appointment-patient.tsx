...
import { PractitionerCancelAppointmentPatientEmailProps } from '../types'
import { extractDate } from '../utils'

export const PractitionerCancelAppointmentPatientEmail = ({
...
export default PractitionerCancelAppointmentPatientEmail
