...
import { UpdateAppointmentClinicEmailProps } from '../types'
import { extractDate } from '../utils'

export const UpdateAppointmentClinicEmail = ({
	...
	patientType = 'New',
	bookedBy = 'Patient',
}: UpdateAppointmentClinicEmailProps) => (
	<EmailLayout>
		<Preview>
			Appointment Updated with {patientName} on {extractDate(appointmentDate)}.
		</Preview>
		<div className="bg-white m-0 mb-8 text-trueGray">
			<div>
				<Text className="font-semibold text-2xl leading-8 mb-6 mt-0">
					Appointment Updated with {patientName} on{' '}
				...
				<Text className="text-base leading-6 mb-6 mt-0">
					The appointment with the following patient has been updated:
				</Text>
				...
				<Text className="text-base leading-6 mb-6 -mt-2">{patientNote}</Text>
				<Text className="text-base leading-6 mb-6 mt-0">
...
export default UpdateAppointmentClinicEmail
