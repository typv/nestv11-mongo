...
import { UpdateAppointmentPractitionerEmailProps } from '../types'
import { extractDate } from '../utils'

export const UpdateAppointmentPractitionerEmail = ({
...
export default UpdateAppointmentPractitionerEmail
